...
class TransformersNER(EntityExtraction):
    ...
    def __init__(self, config):
        ...
        self.classifier = PredictTransformersNER(transformers_model=self.config.get('model', 'xlm-roberta-base'), label2id=self.config.get('label2id', None), session_options=self.config.get('session_options', None))
